...
export declare const useDirectusItems: <Collections extends DirectusCollections>() => {
    getItems: {
        ...
        <C_1 extends keyof Collections, D_1 extends DirectusItemRequest<Collections>[C_1]>(collection: C_1, data?: D_1 | undefined): Promise<Collections[C_1][]>;
    };
    getSingletonItem: <C_2 extends keyof Collections, D_2 extends DirectusItemRequest<Collections>[C_2]>(collection: C_2, data?: D_2 | undefined) => Promise<Collections[C_2]>;
