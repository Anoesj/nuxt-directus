...
- **Arguments:**
  ...
  - data: [`DirectusItemRequest`](https://github.com/Intevel/nuxt-directus/blob/main/src/runtime/types/index.d.ts#L92)
...
- **Arguments:**
  - collection [`keyof Collections`]
  - data: [`DirectusItemCreation`](https://github.com/Intevel/nuxt-directus/blob/main/src/runtime/types/index.d.ts#105)
...
- **Arguments:**
  - collection [`keyof Collections`]
  - data: [`DirectusItemDeletion`](https://github.com/Intevel/nuxt-directus/blob/main/src/runtime/types/index.d.ts#118)
...
- **Arguments:**
  - collection [`keyof Collections`]
  - data: [`DirectusItemUpdate`](https://github.com/Intevel/nuxt-directus/blob/main/src/runtime/types/index.d.ts#111)
